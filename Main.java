        ...
        do {
            ...
            switch (option) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    System.out.println("Buscar Produtos (UUID)");
                    scanner.nextLine();
                    System.out.println("Digite os UUIDs dos produtos que deseja buscar: (UUID, UUID)");
                    String uuids = scanner.nextLine();
                    List<Product> encontrados = listaDeProdutos.findByIdS(uuids);
